package kz.bitlab.TestSpring.security;
...
import static kz.bitlab.TestSpring.security.SecurityConstants.*;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            kz.bitlab.TestSpring.models.entities.User creds = new ObjectMapper()
                    .readValue(req.getInputStream(), kz.bitlab.TestSpring.models.entities.User.class);
            kz.bitlab.TestSpring.models.entities.User user = userService.findByUsername(creds.getUsername());
